...
<div class="cro-card cro-developer-section">
		<header class="cro-card__header cro-developer-section__header">
			...
			<h2 class="cro-card__title"><?php esc_html_e( 'Template overrides', 'cro-toolkit' ); ?></h2>
		</header>
		<div class="cro-card__body">
			<p class="cro-section-desc"><?php esc_html_e( 'Campaign popup templates can be overridden by copying them into your theme.', 'cro-toolkit' ); ?></p>
			<div class="cro-developer-code-block cro-mb-2">
				<code>get_stylesheet_directory() . '/cro-toolkit/templates/<var>template-key</var>.php'</code>
			</div>
			<p><?php esc_html_e( 'Example: to override the centered popup, create this file in your theme:', 'cro-toolkit' ); ?></p>
			<div class="cro-developer-code-block cro-mb-2">
				<code>wp-content/themes/your-theme/cro-toolkit/templates/centered.php</code>
			</div>
			<p><?php esc_html_e( 'Available template keys match the popup names in the campaign builder (e.g. centered, corner, slide-bottom, top-bar). The plugin falls back to the built-in template if the file is missing.', 'cro-toolkit' ); ?></p>
			<p class="cro-mt-2">
				<strong><?php esc_html_e( 'Filter:', 'cro-toolkit' ); ?></strong>
				<code>cro_popup_template</code> — <?php esc_html_e( 'Change the template file path programmatically. Params: $template_path, $template_type.', 'cro-toolkit' ); ?>
			</p>
		</div>
	</div>
	...
	<div class="cro-card cro-developer-section">
		<header class="cro-card__header cro-developer-section__header">
			...
			<h2 class="cro-card__title"><?php esc_html_e( 'Actions', 'cro-toolkit' ); ?></h2>
		</header>
		<div class="cro-card__body">
			<p class="cro-section-desc"><?php esc_html_e( 'Fire your code at key points. Use add_action( \'hook_name\', $callback, $priority, $accepted_args ).', 'cro-toolkit' ); ?></p>
	...
	<div class="cro-card cro-developer-section">
		<header class="cro-card__header cro-developer-section__header">
			...
			<h2 class="cro-card__title"><?php esc_html_e( 'Filters', 'cro-toolkit' ); ?></h2>
		</header>
		<div class="cro-card__body">
			<p class="cro-section-desc"><?php esc_html_e( 'Modify data before it is used. Use add_filter( \'hook_name\', $callback, $priority, $accepted_args ). Return the modified value.', 'cro-toolkit' ); ?></p>
			<div class="cro-developer-hooks-list">
	...
	<div class="cro-card cro-developer-section">
		<header class="cro-card__header cro-developer-section__header">
			...
			<h2 class="cro-card__title"><?php esc_html_e( 'Example snippets', 'cro-toolkit' ); ?></h2>
		</header>
		<div class="cro-card__body">
			<div class="cro-developer-snippets-grid">
				<div class="cro-developer-snippet-card">
					<h4><?php esc_html_e( 'Add custom admin tab', 'cro-toolkit' ); ?></h4>
	...
	return $tabs;
				...
				<div class="cro-developer-snippet-card">
					<h4><?php esc_html_e( 'Track when campaign is shown', 'cro-toolkit' ); ?></h4>
	...
	gtag( 'event', 'cro_popup_shown', array( 'campaign_id' => $campaign_id ) );
				...
				<div class="cro-developer-snippet-card">
					<h4><?php esc_html_e( 'Modify offer context', 'cro-toolkit' ); ?></h4>
	...
	return $context;
				...
				<div class="cro-developer-snippet-card">
					<h4><?php esc_html_e( 'Override popup template path', 'cro-toolkit' ); ?></h4>
