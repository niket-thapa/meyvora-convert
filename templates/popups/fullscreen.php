 ...
 * Fullscreen Template
 * 
 * Full viewport takeover with optional background image
 *
 * @package CRO_Toolkit
 */
...
// Build classes
$classes = [ 'cro-popup', 'cro-popup--fullscreen' ];
if ( $is_preview ) {
...
?>
<?php if ( $is_preview ) : ?>
<div class="cro-preview-viewport cro-preview-viewport--fullscreen">
<?php endif; ?>
...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"
    ...
    <!-- Close Button -->
    <button type="button" class="cro-popup__close cro-popup__close--light" aria-label="<?php esc_attr_e( 'Close', 'cro-toolkit' ); ?>" data-action="close">
    ...
    <!-- Background Image -->
    <div class="cro-popup__background" style="background-image: url('<?php echo esc_url( $content['image_url'] ); ?>');"></div>
    <?php endif; ?>
    ...
    <div class="cro-popup__inner">
        ...
        <h1 class="cro-popup__headline" id="cro-headline-<?php echo esc_attr( $campaign_id ); ?>"
